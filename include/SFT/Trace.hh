...
#include "FG/SavePropertyType.hh"

#define TRACE SFT::Trace t(__FILE__, __LINE__, __PRETTY_FUNCTION__)
...
namespace SFT {
  ...
  public:
    ...
    Trace& detail(const std::string &_name, FG::SavePropertyType _v);
